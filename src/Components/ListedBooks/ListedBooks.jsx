    ...
    <div className="min-h-lvh lg:px-20 md:px-8 sm:px-6 max-sm:px-4 lg:py-12 md:py-8 sm:py-6 max-sm:py-6">
      ...
      <div role="tablist" className="tabs tabs-lifted">
          ...
          <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box lg:p-6 md:p-4 sm:p-2 max-sm:p-2">
                      ...
                      <div className="text-start flex justify-start items-center">
                        ...
                        <p className="">{readBook.total_pages}</p>
										...
										<div className="pt-2 flex justify-start items-center lg:gap-4 md:gap-2 sm:gap-2 max-sm:gap-1">
											<span className="text-fourth lg:text-[15px] bg-[#328EFF26] lg:px-2 md:px-2 sm:px-2 max-sm:px-1 md:text-[15px] sm:text-[15px] max-sm:text-[14px] py-1 rounded-full">Category : {readBook.category}</span>
											<span className="text-fifth lg:text-[15px] bg-[#FFAC3326] lg:px-2 md:px-2 sm:px-2 max-sm:px-1 md:text-[15px] sm:text-[15px] max-sm:text-[14px] py-1 rounded-full">Ratings : {readBook.ratings}</span>
											<button onClick={()=>handleListedBookDetails(readBook.book_id)} className="bg-main text-white lg:text-[15px] lg:px-2 md:px-2 sm:px-2 max-sm:px-1 md:text-[15px] sm:text-[15px] max-sm:text-[14px] py-1 rounded-full">View Details</button>
										</div>
                  </div>
                </div>
              </div>
            ...
            : <p>Nothing selected to the Read books yet.</p>  
          }
          </div>
				{/* Wishlist Books */}
					<input
          ...
          <div role="tabpanel" className="tab-content bg-base-100 border-base-300 rounded-box lg:p-6 md:p-4 sm:p-2 max-sm:p-2">
            {
              ...
              : <p>Nothing selected to the Wishlist books yet.</p>
            }
          </div>
        </div>
      </div>
